<x-app-layout>
    ...
    <main
		...
		<div
			...
			duration-500 ease-in-out">
			<h2 class="text-4xl font-medium capitalize">Users ({{ count($u)}})</h2>
                        ...
                        <div
                            ...
                            <div class="flex">
                                ...
                                <div class="flex flex-col ml-6">
                                    <span class="text-lg font-bold">{{ $users -> full_name  }} | [{{ $users -> email }} ]</span>
                                    <div class="mt-4 flex">
                                        <div class="flex">
                                            <svg
                                    ...
                                    <div class="mt-4 flex">
                                        ...
                                        <form action="{{ url('update_designation') }}" method="POST">
                                            @csrf
                                            @method('PUT')

                                        <input type="hidden" name="id" value="{{ $users -> id }}">
                                        @if(($users -> designation)== 'User')
                                        <input type="hidden" name="new_designation" value="Vendor">
                                        @elseif((($users -> designation)== 'Vendor'))
                                        <input type="hidden" name="new_designation" value="User">
                                        @endif
                                        <button
                                            class="flex items-center ml-4
                                            focus:outline-none border rounded-full
                            ...
                            <div class="flex flex-col mt-5 mr-25">
                                <span
                                ...
                                <span
                                    ...
                                    dark:text-green-300">
                                     # {{ $users -> profile -> daily_earning  }} | 
                                     @php
                                        $user_earned = $users -> profile -> daily_earning;
                                        $user_sub_wt_interest =  ($users -> coupon_plan -> plan_amount)   * 1.5;
                                ...
                                <span
                                    ...
                                    dark:text-green-300">
                                     # {{ $users -> profile -> referral_earning  }}
                                </span>
                                <span
                                    class="text-sm text-green-700 dark:text-green-600
                                    mt-2 border-black border-t-2 border-b-2 ">
                                    # {{ $users -> profile -> referral_earning + $users -> profile -> daily_earning}}
                                </span>
